...
import './overlay-menu.style.scss';

//import linkedin from '../../assets/contact_linkedin.png';
import twitter from '../../assets/contact_twitter.png';
import facebook from '../../assets/contact_facebook.png';
import ins from '../../assets/contact_ins.png';
      ...
      <div id="overlay"
        ...
        <a href="javascript:void(0)"
            ...
            <svg version="1.1" id="&#x56FE;&#x5C42;_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
              y="0px" viewBox="0 0 42 42" xmlSpace="preserve">
            <polygon points="41.86,1.555 40.445,0.14 21,19.586 1.555,0.14 0.14,1.555 19.586,21 0.14,40.445 
        ...
        <div className="overlay__content">
          <div className="menu__item">
            <div className="menu__links">
              ...
              <a href="logo.html">Portfolio</a>
              <a href="contact.html">Contact</a>
            </div>
          </div>
          <div className="menu__contact">
            <div className="menu__contact--content">
              <p><a href="tel:+16502079979">(650) 207-9979</a></p>
              <p className="contact__content-spacing"><a href="mailto:RLD@RussellLeong.com">RLD@RussellLeong.com</a></p>
              <div className="sci">
                <ul className="menu__sci">
                  <li>
                    <div className="linkedin">
                      <svg version="1.1" id="&#x56FE;&#x5C42;_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 24 24" xmlSpace="preserve">
                        <path d="M6.375,4.152c0,1.203-1.009,2.152-2.208,2.152S1.959,5.354,1.959,4.152C1.959,2.949,2.968,2,4.167,2
                          S6.375,2.949,6.375,4.152z M21.959,22h-4.29v-7.595c0-1.962-0.694-2.975-2.082-2.975c-1.136,0-1.83,0.57-2.145,1.646V22h-4.29
                          c0,0,0.063-12.848,0-14.304h3.602l-0.006,2.848h0.063c0.883-1.456,2.271-2.405,4.227-2.405c1.451,0,2.65,0.38,3.533,1.456
                          c0.883,1.013,1.388,2.405,1.388,4.304V22z M6.312,22h-4.29V7.696h4.29V22z"/>
                      </svg>
                      <img src="./assets/contact_Twitter.png" />
                    </div>
                  </li>
                  <li>
                    <div className="bird">
                      <svg version="1.1" id="&#x56FE;&#x5C42;_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 24 24" xmlSpace="preserve">
                        <path d="M17.472,4.738c-0.763,0-1.382,0.624-1.382,1.393
                  ...
                  <li>
                    <div className="fish">
                      <svg version="1.1" id="&#x56FE;&#x5C42;_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 24 24" xmlSpace="preserve">
                        <path d="M14.519,2.246c-0.514,0-0.931,0.399-0.931,0.891c0,0.492,0.417,0.891,0.931,0.891
                  ...
                  <li>
                    <div className="bird">
                      <svg version="1.1" id="&#x56FE;&#x5C42;_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 24 24" xmlSpace="preserve">
                        <path d="M17.938,8.695c-0.371,0.214-0.829,0.214-1.2,0c-0.371-0.214-0.6-0.61-0.6-1.039
